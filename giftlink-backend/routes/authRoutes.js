...
//Step 2 - Create a POST route for user registration
...
router.put('/update', async (req, res) => {
        ...
        if (!errors.isEmpty()) {
            logger.error('Erreurs de validation dans la demande de mise à jour', errors.array());
        ...
        if (!email) {
            ...
            return res.status(400).json({ error: "Email non trouvé dans les en-têtes de la requête" });
        }
